...
import publicationsFr from "@/data/fr/publication.json";
import publicationsEn from "@/data/en/publication.json";
import PublicationModal from "./PublicationModal";

export default function Publication() {
  const { t, language } = useLanguage();
  const [modal, setModal] = useState(null);
  const publicationsData = language === "en" ? publicationsEn : publicationsFr;
